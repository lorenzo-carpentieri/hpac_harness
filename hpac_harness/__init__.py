...
class HPACTvInstance(HPACBenchmarkInstance):
  @dataclass
  class RunParams:
    img: str
    out_img: str
...
class HPACBlurInstance(HPACBenchmarkInstance):
  @dataclass
  class RunParams:
    img: str
    out_img: str
...
class HPACMedianInstance(HPACBenchmarkInstance):
  @dataclass
  class RunParams:
    img: str
    out_img: str
